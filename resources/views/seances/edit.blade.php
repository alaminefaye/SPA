                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="number" step="0.01" class="form-control" id="prix_promo" name="prix_promo" value="{{ old('prix_promo') ?? $seance->prix_promo }}" placeholder="Prix promotionnel (optionnel)" />
