        ...
        <div class="card-body">
            <form action="{{ route('admin.employees.update', $employee) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('numero_telephone') is-invalid @enderror" id="numero_telephone" name="numero_telephone" value="{{ old('numero_telephone', $employee->numero_telephone) }}" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('date_naissance') is-invalid @enderror" id="date_naissance" name="date_naissance" value="{{ old('date_naissance', $employee->date_naissance ? $employee->date_naissance->format('Y-m-d') : '') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('poste') is-invalid @enderror" id="poste" name="poste" required>
                                ...
                                @foreach($postes as $key => $value)
                                    <option value="{{ $key }}" {{ old('poste', $employee->poste) == $key ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                            @error('poste')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('salon_id') is-invalid @enderror" id="salon_id" name="salon_id">
                                ...
                                @foreach($salons as $id => $nom)
                                    <option value="{{ $id }}" {{ old('salon_id', $employee->salon_id) == $id ? 'selected' : '' }}>{{ $nom }}</option>
                                @endforeach
                            </select>
                            @error('salon_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('specialites') is-invalid @enderror" id="specialites" name="specialites" rows="3">{{ old('specialites', $employee->specialites) }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('salaire') is-invalid @enderror" id="salaire" name="salaire" value="{{ old('salaire', $employee->salaire) }}" step="0.01" min="0">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('adresse') is-invalid @enderror" id="adresse" name="adresse" rows="2">{{ old('adresse', $employee->adresse) }}</textarea>
                            @error('adresse')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-2">
                                <div class="d-flex align-items-center">
                                    <img src="{{ Storage::url($employee->photo) }}" alt="Photo actuelle" class="img-thumbnail me-2" style="height: 60px;">
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input @error('actif') is-invalid @enderror" type="checkbox" id="actif" name="actif" value="1" {{ old('actif', $employee->actif) ? 'checked' : '' }}>
