    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">Achat enregistré avec succès</h5>
            </div>
            <div class="card-body">
                <div class="alert alert-success">
                    <i class="bx bx-check-circle me-2"></i>
                    L'achat a été enregistré avec succès. Le ticket d'impression s'ouvrira dans une nouvelle fenêtre.
                </div>
                ...
                <div class="mt-4">
                    <a href="{{ $redirectUrl }}" class="btn btn-secondary">
                        <i class="bx bx-arrow-back me-1"></i> Retour aux détails de l'achat
                    </a>
                </div>
            </div>
        </div>
